...
;------------------------------------------------------------
;	/opt/contiki/core/sys/stimer.c:67: stimer_set(struct stimer *t, unsigned long interval)
;	-----------------------------------------
;	 function stimer_set
;	-----------------------------------------
_stimer_set:
	...
	push	dph
	push	b
;	/opt/contiki/core/sys/stimer.c:69: t->interval = interval;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x04
	...
	mov	a,@r0
	lcall	__gptrput
;	/opt/contiki/core/sys/stimer.c:70: t->start = clock_seconds();
...
;------------------------------------------------------------
;	/opt/contiki/core/sys/stimer.c:87: stimer_reset(struct stimer *t)
;	-----------------------------------------
...
_stimer_reset:
	...
	mov	a,sp
	add	a,#0x04
;	/opt/contiki/core/sys/stimer.c:89: t->start += t->interval;
	mov	sp,a
	add	a,#0xfa
	mov	r0,a
	mov	dpl,@r0
...
;------------------------------------------------------------
;	/opt/contiki/core/sys/stimer.c:107: stimer_restart(struct stimer *t)
;	-----------------------------------------
...
_stimer_restart:
	...
	mov	r6,dph
	mov	r7,b
;	/opt/contiki/core/sys/stimer.c:109: t->start = clock_seconds();
	push	ar7
	push	ar6
	push	ar5
	mov	r0,#_clock_seconds
...
;------------------------------------------------------------
;	/opt/contiki/core/sys/stimer.c:124: stimer_expired(struct stimer *t)
;	-----------------------------------------
...
_stimer_expired:
	...
	mov	r6,dph
	mov	r5,b
;	/opt/contiki/core/sys/stimer.c:126: return SCLOCK_GEQ(clock_seconds(), t->start + t->interval);
	push	ar7
	push	ar6
	push	ar5
	mov	r0,#_clock_seconds
...
;t                         Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	/opt/contiki/core/sys/stimer.c:140: stimer_remaining(struct stimer *t)
;	-----------------------------------------
;	 function stimer_remaining
;	-----------------------------------------
_stimer_remaining:
;	/opt/contiki/core/sys/stimer.c:142: return t->start + t->interval - clock_seconds();
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
	lcall	__gptrget
...
;t                         Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	/opt/contiki/core/sys/stimer.c:156: stimer_elapsed(struct stimer *t)
;	-----------------------------------------
...
_stimer_elapsed:
	...
	mov	r6,dph
	mov	r7,b
;	/opt/contiki/core/sys/stimer.c:158: return clock_seconds() - t->start;
	push	ar7
	push	ar6
	push	ar5
	mov	r0,#_clock_seconds
