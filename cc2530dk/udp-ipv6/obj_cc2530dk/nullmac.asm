...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullmac.c:49: send_packet(mac_callback_t sent, void *ptr)
;	-----------------------------------------
...
_send_packet:
	...
	mov	r6,dph
	mov	r7,b
;	/opt/contiki/core/net/mac/nullmac.c:51: NETSTACK_RDC.send(sent, ptr);
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullmac.c:55: packet_input(void)
;	-----------------------------------------
;	 function packet_input
;	-----------------------------------------
_packet_input:
;	/opt/contiki/core/net/mac/nullmac.c:57: NETSTACK_LLSEC.input();
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullmac.c:61: on(void)
;	-----------------------------------------
;	 function on
;	-----------------------------------------
_on:
;	/opt/contiki/core/net/mac/nullmac.c:63: return NETSTACK_RDC.on();
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullmac.c:67: off(int keep_radio_on)
;	-----------------------------------------
;	 function off
;	-----------------------------------------
_off:
	mov	r6,dpl
	mov	r7,dph
;	/opt/contiki/core/net/mac/nullmac.c:69: return NETSTACK_RDC.off(keep_radio_on);
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullmac.c:73: channel_check_interval(void)
;	-----------------------------------------
;	 function channel_check_interval
;	-----------------------------------------
_channel_check_interval:
;	/opt/contiki/core/net/mac/nullmac.c:75: return 0;
	mov	dptr,#0x0000
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'init'
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullmac.c:79: init(void)
;	-----------------------------------------
;	 function init
;	-----------------------------------------
_init:
;	/opt/contiki/core/net/mac/nullmac.c:81: }
	ljmp	__sdcc_banked_ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
_nullmac_driver:
