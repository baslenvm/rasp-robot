...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:48: send_packet(mac_callback_t sent, void *ptr)
;	-----------------------------------------
...
_send_packet:
	...
	inc	sp
	inc	sp
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:51: if(NETSTACK_RADIO.send(packetbuf_hdrptr(), packetbuf_totlen()) == RADIO_TX_OK) {
	...
	mov	a,r2
	orl	a,r3
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:52: ret = MAC_TX_OK;
	jnz	00102$
	mov	r6,a
	mov	r7,a
	sjmp	00103$
00102$:
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:54: ret =  MAC_TX_ERR;
	mov	r6,#0x04
	mov	r7,#0x00
00103$:
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:56: mac_call_sent_callback(sent, ptr, ret, 1);
	mov	a,#0x01
	push	acc
	clr	a
	push	acc
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:60: send_list(mac_callback_t sent, void *ptr, struct rdc_buf_list *buf_list)
;	-----------------------------------------
;	 function send_list
;	-----------------------------------------
_send_list:
	...
	mov	r6,dph
	mov	r7,b
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:62: if(buf_list != NULL) {
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	a,@r0
	...
	orl	a,@r0
	jz	00103$
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:63: queuebuf_to_packetbuf(buf_list->buf);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	ar2,@r0
	...
	pop	ar6
	pop	ar7
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:64: send_packet(sent, ptr);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,@r0
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:69: packet_input(void)
;	-----------------------------------------
;	 function packet_input
;	-----------------------------------------
_packet_input:
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:71: NETSTACK_MAC.input();
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:75: on(void)
;	-----------------------------------------
;	 function on
;	-----------------------------------------
_on:
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:77: return NETSTACK_RADIO.on();
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:81: off(int keep_radio_on)
;	-----------------------------------------
;	 function off
;	-----------------------------------------
_off:
	mov	r6,dpl
	mov	r7,dph
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:83: if(keep_radio_on) {
	mov	a,r6
	orl	a,r7
	jz	00102$
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:84: return NETSTACK_RADIO.on();
	mov	dptr,#(_cc2530_rf_driver + 0x0018)
	clr	a
	movc	a,@a+dptr
	mov	r5,a
	...
	sjmp	00104$
00102$:
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:86: return NETSTACK_RADIO.off();
...
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:91: channel_check_interval(void)
;	-----------------------------------------
;	 function channel_check_interval
;	-----------------------------------------
_channel_check_interval:
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:93: return 0;
	mov	dptr,#0x0000
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'init'
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:97: init(void)
;	-----------------------------------------
;	 function init
;	-----------------------------------------
_init:
;	/opt/contiki/core/net/mac/nullrdc-noframer.c:99: on();
	mov	r0,#_on
	mov	r1,#(_on >> 8)
	mov	r2,#(_on >> 16)
	lcall	__sdcc_banked_call
