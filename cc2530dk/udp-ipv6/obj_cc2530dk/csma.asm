...
_metadata_memb_memb_mem:
	.ds 42
_send_packet_initialized_1_268:
	.ds 1
_send_packet_seqno_1_268:
	.ds 2
;--------------------------------------------------------
...
;initialized               Allocated with name '_send_packet_initialized_1_268'
;seqno                     Allocated with name '_send_packet_seqno_1_268'
;------------------------------------------------------------
;	/opt/contiki/core/net/mac/csma.c:323: static uint8_t initialized = 0;
	mov	dptr,#_send_packet_initialized_1_268
	clr	a
	movx	@dptr,a
;--------------------------------------------------------
; Home
...
;status                    Allocated to stack - sp -15
...
;metadata                  Allocated to stack - sp -14
;time                      Allocated to stack - sp -11
...
;	/opt/contiki/core/net/mac/csma.c:330: seqno = random_rand();
	...
	mov	a,dpl
	mov	b,dph
	mov	dptr,#_send_packet_seqno_1_268
	movx	@dptr,a
	mov	a,b
	inc	dptr
	movx	@dptr,a
