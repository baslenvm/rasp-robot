...
;------------------------------------------------------------
;	/opt/contiki/core/net/llsec/nullsec.c:52: init(void)
;	-----------------------------------------
;	 function init
;	-----------------------------------------
_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	/opt/contiki/core/net/llsec/nullsec.c:55: }
...
;------------------------------------------------------------
;	/opt/contiki/core/net/llsec/nullsec.c:58: send(mac_callback_t sent, void *ptr)
;	-----------------------------------------
;	 function send
;	-----------------------------------------
_send:
	...
	mov	r6,dph
	mov	r7,b
;	/opt/contiki/core/net/llsec/nullsec.c:60: packetbuf_set_attr(PACKETBUF_ATTR_FRAME_TYPE, FRAME802154_DATAFRAME);
	push	ar7
	push	ar6
	push	ar5
	mov	a,#0x01
	...
	pop	ar6
	pop	ar7
;	/opt/contiki/core/net/llsec/nullsec.c:61: NETSTACK_MAC.send(sent, ptr);
...
;------------------------------------------------------------
;	/opt/contiki/core/net/llsec/nullsec.c:65: input(void)
;	-----------------------------------------
;	 function input
;	-----------------------------------------
_input:
;	/opt/contiki/core/net/llsec/nullsec.c:67: NETSTACK_NETWORK.input();
