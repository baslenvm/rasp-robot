...
;------------------------------------------------------------
;	/opt/contiki/core/net/netstack.c:43: netstack_init(void)
;	-----------------------------------------
...
_netstack_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	/opt/contiki/core/net/netstack.c:45: NETSTACK_RADIO.init();
	...
	pop	ar6
	pop	ar7
;	/opt/contiki/core/net/netstack.c:46: NETSTACK_RDC.init();
	...
	pop	ar6
	pop	ar7
;	/opt/contiki/core/net/netstack.c:47: NETSTACK_MAC.init();
	...
	pop	ar6
	pop	ar7
;	/opt/contiki/core/net/netstack.c:48: NETSTACK_NETWORK.init();
